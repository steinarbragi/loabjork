    ...
    <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
      {!isSubmitSuccessful && (
        ...
        >
          <input
            type="hidden"
            value="b80d5198-95ac-4522-8a39-a6fbfe9087d7"
            {...register('access_key')}
          />
          <input
            type="hidden"
      ...
      {isSubmitSuccessful && isSuccess && (
        <div className="grid grid-cols-1 center gap-x-8 gap-y-6 sm:grid-cols-2">
          <div className="lg:mt-40 text-center text-white rounded-md flex flex-col justify-center">
            <svg
              width="100"
              height="100"
            ...
            <h3 className="py-5 text-2xl text-green-500">{t('success')}</h3>
      ...
      {isSubmitSuccessful && !isSuccess && (
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div className="lg:mt-40 text-center text-white rounded-md flex flex-col justify-center">
            ...
            <h3 className="text-2xl text-red-400 py-7">{t('oops')}</h3>
            <p className="text-gray-500 md:px-3">{message}</p>
            <button
              type="button"
              className="mt-5 focus:outline-none text-gray-500"
              onClick={() => reset()}
            >
              {t('tryagain')}
            </button>
